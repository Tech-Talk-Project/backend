...
@Getter
@NoArgsConstructor
public class PromotionBoard extends BoardEntity{
    @Id @GeneratedValue
    @Column(name = "promotion_board_id")
    private Long id;

    @OneToMany(mappedBy = "promotionBoard", cascade = CascadeType.ALL, orphanRemoval = true)
    ...
    public void addThumbsUp(ThumbsUp thumbsUp) {
        ...
        thumbsUp.setPromotionBoard(this);
    }

    public void addThumbsDown(ThumbsDown thumbsDown) {
        thumbsDowns.add(thumbsDown);
        thumbsDown.setPromotionBoard(this);
    }

    public void addComment(Comment comment) {
        comments.add(comment);
        comment.setPromotionBoard(this);
    }

    public void addTag(Tag tag) {
        tags.add(tag);
        tag.setPromotionBoard(this);
    }
    ...
    public PromotionBoard(Member member, BoardCreateRequestDto dto) {
        this.author = member;
        this.title = dto.getTitle();
        this.content = dto.getContent();
